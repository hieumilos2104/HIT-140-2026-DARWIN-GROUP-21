...
SAMPLE_FILE_NAME = "task3_player_random_sample_50.csv"
...
# --------------------------------------------------
# 6. Take and save a simple random sample
# --------------------------------------------------

if SAMPLE_SIZE > len(eligible_players):
    raise ValueError(
        "SAMPLE_SIZE is larger than the eligible population."
    )

sample = eligible_players.sample(
    n=SAMPLE_SIZE,
...
# Density is used because the UEFA and CONMEBOL sample sizes differ.
axes[0].hist(
    uefa_values,
    bins=bins,
    density=True,
